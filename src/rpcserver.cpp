...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* ETTER features */
        {"etter", "masternode", &masternode, true, true, false},
        {"etter", "masternodelist", &masternodelist, true, true, false},
        {"etter", "mnbudget", &mnbudget, true, true, false},
        {"etter", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"etter", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"etter", "mnsync", &mnsync, true, true, false},
        {"etter", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use etterd, or the -server option to etter-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> etter-cli " + methodname + " " + args + "\n";
}
