...
public:
	...
	vSeeds.push_back(CDNSSeedData("s1.etter.live", "s1.etter.live"));
	vSeeds.push_back(CDNSSeedData("s2.etter.live", "s2.etter.live"));
	vSeeds.push_back(CDNSSeedData("s3.etter.live", "s3.etter.live"));
