...
/** Utility functions used by the ETTER Qt UI.
 */
namespace GUIUtil
{
...
// Render ETTER addresses in monospace font
...
// Parse "etter:" URI into recipient object, return true on successful parsing
