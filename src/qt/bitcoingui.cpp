                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("ETTER-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ETTER address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and etter: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About ETTER Core"), this);
    aboutAction->setStatusTip(tr("Show information about ETTER Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ETTER"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ETTER addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ETTER addresses"));
    ...
    openAction->setStatusTip(tr("Open a ETTER: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the ETTER Core help message to get a list with possible ETTER command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("ETTER Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ETTER network", "", count));
}
...
{
    QString strTitle = tr("ETTER Core"); // default title
