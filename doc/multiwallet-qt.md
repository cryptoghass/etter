...
In order to support loading of multiple wallets in etter-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is etter.cpp.
...
Changes to etter.cpp
----------------------
etter.cpp is the entry point into etter-qt, and as such, will require some minor modifications to provide hooks for
