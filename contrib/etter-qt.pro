...
RESOURCES += src/qt/etter.qrc src/qt/etter_locale.qrc

TRANSLATIONS += src/qt/locale/etter_bg.ts \
                src/qt/locale/etter_de.ts \
                src/qt/locale/etter_en.ts \
                src/qt/locale/etter_es.ts \
                src/qt/locale/etter_fi.ts \
                src/qt/locale/etter_fr.ts \
                src/qt/locale/etter_it.ts \
                src/qt/locale/etter_ja.ts \
                src/qt/locale/etter_pl.ts \
                src/qt/locale/etter_pt.ts \
                src/qt/locale/etter_ru.ts \
                src/qt/locale/etter_sk.ts \
                src/qt/locale/etter_sv.ts \
                src/qt/locale/etter_vi.ts \
                src/qt/locale/etter_zh_CN.ts \
                src/qt/locale/etter_zh_TW.ts
