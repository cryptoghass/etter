...
COINDOWNLOADLINK1=https://github.com/etterteam/etter/releases/download/v1.0/etterd
COINDOWNLOADLINK2=https://github.com/etterteam/etter/releases/download/v1.0/etter-cli
COINDOWNLOADLINK3=https://github.com/etterteam/etter/releases/download/v1.0/etter-tx
COINPORT=30001
COINRPCPORT=30002
COINDAEMON=etterd
COINDAEMONCLI=etter-cli
COINDAEMONTX=etter-tx
COINCORE=.etter
COINCONFIG=etter.conf
